...
# To run file or class --> py.test -s S01_SetupAndYield_NOclass_test.py
#To run single method -->pytest -v -s S01_SetupAndYield_NOclass_test.py::test_methodB
...
#pytest -v -s S01_SetupAndYield_NOclass_test.py