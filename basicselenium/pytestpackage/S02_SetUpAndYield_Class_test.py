...
# To run individual --> py.test -s S02_SetUpAndYield_Class_test.py
#       to run all --------------> py.test -v -s
#       to run only one class ---> py.test -v -s S02_SetUpAndYield_Class_test.py
#       to run only one method --> py.test -v -s S02_SetUpAndYield_Class_test.py::test_methodA
